    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('xml_link', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.xmllink')),
            ],
        ),
        migrations.AddField(
            model_name='channel',
            name='xml_link',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.xmllink'),
        ),
    ]
